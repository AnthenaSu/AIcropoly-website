...
export default function Home() {
  return (
    <main className="bg-parchment">
      ...
      {/* ── Metrics ── */}
      <section className="py-20 md:py-28 px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 2xl:px-48">
        <div>
      ...
      {/* ── Problem image + quote ── */}
      <section className="pb-20 md:pb-28 px-8 sm:px-12 md:px-16 lg:px-24 xl:px-32 2xl:px-48">
        <div>
          <motion.div
