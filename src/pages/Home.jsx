...
export default function Home() {
  ...
  return (
    <main className="bg-parchment">
      ...
      {/* ── Intro text ── */}
      <section className={WRAP} style={{ paddingTop: '5rem', paddingBottom: '0' }}>
        <motion.p
          variants={rise(0)} initial="hidden" whileInView="visible" viewport={{ once: true }}
          className="text-center text-fg text-xl md:text-2xl leading-relaxed max-w-3xl mx-auto"
        >
          Continuous, battery-free structural monitoring for extreme industrial environments. We turn CUI and micro-cracks into predictable intelligence before failures occur.
        </motion.p>
      </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            >
              ...
              <p className="text-base text-fg-muted leading-relaxed">{item.body}</p>
            </motion.div>
          ))}
        </div>
      </section>
